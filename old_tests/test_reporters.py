import pytest
import os
from lettuce import TaylorGreenVortex2D, TaylorGreenVortex3D, PoiseuilleFlow2D, \
    Lattice, D3Q27, D2Q9, write_image, \
...
from lettuce.util.observables import Enstrophy, EnergySpectrum, MaximumVelocity, IncompressibleKineticEnergy, Mass
import numpy as np
import torch
