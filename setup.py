...
setup(
    ...
    packages=find_packages(include=[
        'lettuce',
        'lettuce.ext',
        'lettuce.ext.boundary',
        'lettuce.ext.collision',
        'lettuce.ext.equilibrium',
        'lettuce.ext.flows',
        'lettuce.ext.force',
        'lettuce.ext.reporter',
        'lettuce.ext.stencil',
        'lettuce.native',
        'lettuce.native.ext',
        'lettuce.native.ext.boundary',
        'lettuce.native.ext.collision',
        'lettuce.native.ext.equilibrium',
        'lettuce.native.ext.force',
        'lettuce.util']),
