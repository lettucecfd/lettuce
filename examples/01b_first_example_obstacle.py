...
The lattice is defined by the used stencil (mostly D2Q9, D3Q19, or D3Q27).
...
"""
energyreporter = lt.ObservableReporter(
    lt.IncompressibleKineticEnergy(lattice, flow), interval=1000, out=None)
